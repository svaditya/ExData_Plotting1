...
plot(queryResult$Global_active_power,type="l",xaxt="n",ylab="Global Active Power (kilowatts)")
v1<-c(0,length(queryResult$Global_active_power)/2,length(queryResult$Global_active_power))
v2<-c("Thu","Fri","Sat")
